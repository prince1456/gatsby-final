...
function EditableImage({data, index}) {
  return (
...
const image_template = {
  ...
  fields: [
    ...
    { name: "height", component: "number", label: "Height" },
    { name: "width", component: "number", label: "width" },
    { name: "padding", component: "text", label: "Padding", placeholder:"ex: 10px 20px 10px 10px" },
